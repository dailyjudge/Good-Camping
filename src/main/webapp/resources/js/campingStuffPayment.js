function searchAddr() {
  new daum.Postcode({
    oncomplete: function (data) {
      ...
      document.getElementById("stuff-roadAddress").value = roadAddr;
      document.getElementById("stuff-jibunAddress").value = data.jibunAddress;

      // 참고항목 문자열이 있을 경우 해당 필드에 넣는다.
      if (roadAddr !== "") {
        document.getElementById("stuff-extraAddress").value = extraRoadAddr;
      } else {
