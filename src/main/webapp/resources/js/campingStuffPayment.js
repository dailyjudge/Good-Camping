...
// document.getElementById("stuff-extraAddress").value = extraAddr;
...
function goOrderPage() {
	...
	return true;
//	var postcode = $("#stuff-postcode").val()
//	var addr = $("#stuff-Address").val()
//	var detailAddr = $("#stuff-detailAddress").val()
//	
...
//	console.log(data);
//	
//	location.href = "go.stuff.buy?so_postcode=" + postcode+"&so_addr="+addr+"&so_detailAddr="+detailAddr+"&so_data"+data;
}
