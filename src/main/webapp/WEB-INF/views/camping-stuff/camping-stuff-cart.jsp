	...
	<div id="cart-div">
		<div id="stuff-cart-list">
			<div class="stuff-cart-top">
				<input id="stuff-in-cart-allcheck" type="checkbox" />전체선택&nbsp;&nbsp;|&nbsp;&nbsp;<span onclick="deleteCheckedItem()">선택삭제</span>
			</div>
			<c:forEach var="c" items="${carts }">
				<div class="stuff-in-cart stuff-in-cart-${c.sc_cart_id }">
					<input class="stuff-in-cart-check" type="checkbox" value="${c.sc_cart_id }"/> 
					...
					<div class="stuff-in-cart-price">
						<input class="stuff-hidden-price-input" type="hidden" value="${c.s_price *c.sc_amount }">
						<fmt:formatNumber value="${c.s_price *c.sc_amount }" pattern="#,###" />
						원
					</div>
				</div>
			</c:forEach>
			<c:if test="${ !empty  carts}">
				<div class="stuff-total-price">
					<span class="stuff-total-price-span"> 결제예정금액&nbsp;&nbsp; 
